...
with st.sidebar:
    ...
    ref_name = st.text_input(
        'Type the name of the reference!', placeholder='Name of Reference Condition')


st.title('LAB Color Analyzer Suite')
st.markdown('A tool for analyzing color data generated by either the Aeros spectrophotometer or Konica Minolta CR-400.')
...
if ref_name is not None:
    ...
    if de_table is not None:
        ...
        de_scatter = px.scatter(
            de_table, x=de_table.index, y=de_table.columns[-1], color=de_table.index)
        ...
        de_scatter.update_layout(
            title_text='ΔE2000 from ' + ref_name, title_x=0.5, title_font={"size": 20})
...
if trials is not None:
    ...
    raw_table = table[table.index.str.contains('raw')]
    cooked_table = table[table.index.str.contains('cook')]
