...
l_star = st.text_input('Type a reference L*', type = 'float')
a_star = st.text_input('Type a reference a*', type = 'float')
b_star = st.text_input('Type a reference b*', type = 'float')
